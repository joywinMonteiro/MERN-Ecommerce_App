    ...
    <div className="min-h-screen mt-10">
      <div className="flex relative">
        ...
        <img
          src={slide_arrow}
          alt="Next Slide"
          className="p-2 cursor-pointer rounded-xl bg-gray-300 absolute top-1/2 right-5 transform -translate-y-1/2"
          onClick={nextSlide}
        />
        <img
          src={slide_arrow}
          alt="Previous Slide"
          className="p-2 cursor-pointer rounded-xl bg-gray-300 absolute top-1/2 left-5 transform -translate-y-1/2 rotate-180"
          onClick={prevSlide}
        />
      </div>
      <div>
